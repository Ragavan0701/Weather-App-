...
function showWeaterReport(weather) {
    ...
    if(city_code==='400'){ 
        ...
        swal("Sorry Could not find", "entered city didn't matched", "warning");
        reset();
    }
    else{
...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = "C:\Users\MANOJ KUMAR\Desktop\Weather App\images\clouds.jpg";
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = "C:\Users\MANOJ KUMAR\Desktop\Weather App\images\rainy.jpg";
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = "C:\Users\MANOJ KUMAR\Desktop\Weather App\images\clear.jpg";
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = "C:\Users\MANOJ KUMAR\Desktop\Weather App\images\snow.jpg";
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = "C:\Users\MANOJ KUMAR\Desktop\Weather App\images\sunny.jpg";
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = "C:\Users\MANOJ KUMAR\Desktop\Weather App\images\thunderstrom.jpg";
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = "C:\Users\MANOJ KUMAR\Desktop\Weather App\images\drizzle.jpg";
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = "C:\Users\MANOJ KUMAR\Desktop\Weather App\images\mist.jpg";
    }

    else {
        document.body.style.backgroundImage = "C:\Users\MANOJ KUMAR\Desktop\Weather App\images\bg.jpg";
    }
}
